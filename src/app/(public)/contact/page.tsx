      ...
      <section className="bg-surface-dark border-t border-white/10 relative z-10 premium-shadow-lg">
        ...
        <div className="border-t border-white/5 max-w-7xl mx-auto px-6 py-5 flex flex-wrap gap-4 items-center">
          <a
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-surface-container-low hover:bg-[#25D366]/20 text-on-surface hover:text-[#25D366] border border-outline-variant hover:border-[#25D366]/50 transition-all text-sm font-semibold tracking-wide rounded-lg premium-shadow-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-5 py-2.5 bg-surface-container-low hover:bg-[#1877F2]/20 text-on-surface hover:text-[#1877F2] border border-outline-variant hover:border-[#1877F2]/50 transition-all text-sm font-semibold tracking-wide rounded-lg premium-shadow-sm"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col">
            <ScrollReveal>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <p className="text-sm uppercase tracking-[0.2em] text-accent font-semibold">Visit Us</p>
                  <h2 className="text-xl md:text-2xl font-display font-bold tracking-tight text-on-surface">Head Office</h2>
                </div>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <div className="bg-surface-container-low p-6 premium-shadow interactive-card cursor-default space-y-2 text-on-surface-variant leading-relaxed">
                <p>No. 161/A, Polhengoda Road,</p>
                <p>Kirulapona, Colombo 05.</p>
                <div className="h-px bg-outline-variant/30 my-4" />
                <p className="font-semibold text-on-surface flex items-center gap-2"><Phone className="w-4 h-4 text-accent"/> +94 773508325 / +94 772303950</p>
                <p className="font-semibold text-on-surface flex items-center gap-2 mt-2"><Mail className="w-4 h-4 text-accent"/> fade16022025@gmail.com</p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="flex flex-col">
            <ScrollReveal delay={150}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <p className="text-sm uppercase tracking-[0.2em] text-accent font-semibold">Islandwide</p>
                  <h2 className="text-xl md:text-2xl font-display font-bold tracking-tight text-on-surface">Other Showrooms</h2>
                </div>
              </div>
            </ScrollReveal>
          ...
          <div className="flex flex-col">
            <ScrollReveal delay={250}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <p className="text-sm uppercase tracking-[0.2em] text-accent font-semibold">Schedule</p>
                  <h2 className="text-xl md:text-2xl font-display font-bold tracking-tight text-on-surface">Business Hours</h2>
                </div>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={350}>
              <div className="bg-surface-container-low p-6 premium-shadow interactive-card space-y-3 text-sm">
                {[
                  { day: "Monday – Saturday", time: "9:00 AM – 6:30 PM" },
                  { day: "Sunday", time: "Closed" },
                  { day: "Public Holidays", time: "Closed" },
                ].map((item) => (
                  <div key={item.day} className="flex justify-between py-3 border-b border-outline-variant/30 last:border-0 hover:bg-surface-container transition-colors px-2 rounded">
                    <span className="text-on-surface font-medium">{item.day}</span>
                    <span className="text-on-surface-variant font-semibold text-accent">{item.time}</span>
                  </div>
                ))}
              </div>
            </ScrollReveal>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="form-field-animate bg-transparent border-b-2 border-outline-variant/40 focus:border-accent outline-none py-3 pr-10 text-on-surface transition-colors appearance-none cursor-pointer rounded-none w-full"
                        disabled={isSubmitting}
                      >
                        <option className="bg-surface-dark text-on-surface">Residential</option>
                        <option className="bg-surface-dark text-on-surface">Commercial</option>
                        <option className="bg-surface-dark text-on-surface">Public Space</option>
                        <option className="bg-surface-dark text-on-surface">Other</option>
                      </select>
                      <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none text-accent">
