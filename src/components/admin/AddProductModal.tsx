...
export function AddProductModal({ categories }: { categories: { name: string, slug: string }[] }) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-white rounded-2xl shadow-2xl z-[101] animate-[scale-in_0.2s_ease-out] overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4 overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 font-mono focus:bg-white focus:border-accent outline-none transition-all"
            />
          </div>
