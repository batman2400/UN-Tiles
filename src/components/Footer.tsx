      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="col-span-1 md:col-span-1 flex flex-col space-y-6">
          ...
          <div className="flex space-x-4 pt-2">
            ...
            <a href="https://www.facebook.com/unicornenterpriseslk/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-surface-dark-elevated flex items-center justify-center text-on-surface-dark-variant hover:bg-accent hover:text-on-accent transition-colors duration-300" aria-label="Facebook">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
              </svg>
            </a>
            <a href="https://wa.me/94773508325" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-surface-dark-elevated flex items-center justify-center text-on-surface-dark-variant hover:bg-accent hover:text-on-accent transition-colors duration-300" aria-label="WhatsApp">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="mailto:fade16022025@gmail.com" className="w-9 h-9 bg-surface-dark-elevated flex items-center justify-center text-on-surface-dark-variant hover:bg-accent hover:text-on-accent transition-colors duration-300">
