...
export function Hero10({
  ...
  return (
    <section
      className="relative isolate min-h-screen w-full overflow-hidden bg-background font-sans text-slate-900 antialiased"
      style={{
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[760px] w-full max-w-[1440px] flex-col px-5 py-5 sm:min-h-screen sm:px-10 lg:px-[74px]">
        <div className="mx-auto flex w-full max-w-[760px] flex-1 flex-col items-center pt-[76px] text-center sm:pt-[94px] lg:pt-[68px]">
          <div className="inline-flex min-h-7 items-center gap-2 rounded-full border border-slate-700/13 bg-white/18 px-3.5 text-[11px] leading-none font-medium text-slate-600 shadow-[0_1px_1px_rgba(255,255,255,0.45)_inset] backdrop-blur-md">
          ...
          <h1 className="mt-5 max-w-5xl font-serif text-[clamp(3.25rem,4.8vw,5.35rem)] leading-[0.92] font-medium tracking-[-0.07em] text-balance whitespace-pre-line text-slate-700">
            {title}
          </h1>

          <p className="mt-6 max-w-[570px] text-[clamp(1rem,1.35vw,1.16rem)] leading-[1.42] font-normal text-pretty whitespace-pre-line text-slate-900 sm:text-slate-700">
            {description}
          </p>
        ...
        <div className="mb-0 flex flex-col items-center gap-4 sm:mb-7 sm:flex-row sm:items-end sm:justify-center">
          <div className="inline-flex w-fit items-center gap-3 rounded-full bg-white/14 p-px pr-4 text-sm font-semibold text-slate-800 shadow-[0_0px_1px_rgba(255,255,255,0.5)_inset] backdrop-blur-sm">
